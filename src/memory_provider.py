...
class MemoryProvider(ABC):
    """Base contract for Aigenchain memory providers.
...
class NativeMemoryProvider(MemoryProvider):
    """Provider adapter for Aigenchain' built-in memory manager and vector store."""

    provider_id = "native"
    display_name = "Aigenchain native memory"
