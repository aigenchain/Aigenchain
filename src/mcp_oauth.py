...
Registration, authorization-code + PKCE, token refresh) to Aigenchain's web
...
# on Aigenchain. APP_PORT is intentionally not used: it is only the Docker host
