...
COPILOT_USER_AGENT = os.environ.get(
    "AIGENCHAIN_COPILOT_USER_AGENT", "Aigenchain/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "AIGENCHAIN_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "AIGENCHAIN_COPILOT_EDITOR_VERSION", "Aigenchain/1.0"
)
