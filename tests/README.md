...
```text
[order-report] working directory: /path/to/aigenchain
...
[order-report] reproduce with: /path/to/aigenchain/venv/bin/python /path/to/aigenchain/tests/run_order_report.py --seed 284734921 -- tests/cli/ -q
```
