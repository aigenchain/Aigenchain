"""`aigenchain-research list --status complete` was returning nothing.
...
Part of #2122 (aigenchain-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "aigenchain-research"
    loader = importlib.machinery.SourceFileLoader("aigenchain_research_cli", str(path))
