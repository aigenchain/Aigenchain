...
// ── Key constants ──
export const KEYS = {
  THEME: 'aigenchain-theme',
  TOGGLES: 'aigenchain-toggles',
  ...
  MODELS_EXPANDED: 'aigenchain-model-expanded',
  MODEL_ENDPOINTS: 'aigenchain-model-endpoints',
  MODEL_SELECTED: 'aigenchain-selected-model',
  SORT_ORDER: 'aigenchain-sessions-sort',
  CHAT_SEARCH_SCOPE: 'aigenchain-search-scope',
  INCOGNITO: 'aigenchain-incognito',
  RAG_ACTIVE: 'aigenchain-rag-active',
  MCP_ACTIVE: 'aigenchain-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'aigenchain-density',
  UI_SCALE: 'aigenchain-ui-scale',
  WORKSPACE: 'aigenchain-workspace'
};
