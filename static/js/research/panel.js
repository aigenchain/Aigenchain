  ...
  return `
    ...
    <div class="modal-body research-pane-body" data-no-swipe-dismiss>
      <div class="research-new-job">
        ...
        <textarea id="research-query" class="research-query" placeholder="e.g. Analyze the evolution of artificial intelligence from early expert systems to modern generative AI, including key breakthroughs and future trends" rows="4"></textarea>
