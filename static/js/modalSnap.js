...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'aigenchain-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'aigenchain-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('aigenchain:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
