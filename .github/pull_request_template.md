...
- [ ] I searched [open issues](https://github.com/aigenchain/Aigenchain/issues) and [open PRs](https://github.com/aigenchain/Aigenchain/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses Aigenchain's existing visual language. Specifically:
