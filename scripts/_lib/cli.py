"""scripts/_lib/cli.py — shared scaffolding for the `aigenchain-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("aigenchain-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/aigenchain-foo`
...
VERSION = "0.1.0"  # bumped centrally; every aigenchain-* CLI reports this
