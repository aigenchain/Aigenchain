...
Imports MemoryManager and MemoryVectorStore from the Aigenchain codebase.
"""
...
_OWNER_ENV_KEYS = ("AIGENCHAIN_MCP_MEMORY_OWNER", "AIGENCHAIN_MEMORY_OWNER")
_OWNER_SCOPE_ERROR = (
    "Error: Memory MCP owner is not configured for an owner-scoped memory store. "
    "Set AIGENCHAIN_MCP_MEMORY_OWNER for this server or use the owner-aware native memory tool."
)
