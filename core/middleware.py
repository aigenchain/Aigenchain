...
INTERNAL_TOOL_TOKEN = os.environ.get("AIGENCHAIN_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-Aigenchain-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-Aigenchain-Internal-Token), or
